    ...
    <div>
      <div className="pt-20 pb-20 bg-red-500 bg-[url(/assets/paisagem2.jpeg)] justify-center p-6 font-poppins bg-no-repeat bg-cover bg-center">
        ...
        <div className="m-auto w-[25%] justify-between flex items-center mt-5">
          <button className="bg-folha text-white rounded-md p-3">
            Procurar Carona
          </button>
          <button className="bg-folha text-white rounded-md p-3">
            Oferecer Carona
      ...
      <div className="pt-20 bg-gray-300 justify-center p-6 font-poppins">
        ...
        <div className="flex text-center justify-between mt-10 mb-10 pl-28 pr-28">
          <div className="w-96">
            ...
            <h4>
              Encontre uma carona para o seu destino ou ofereça vagas
              disponíveis
            </h4>
          </div>
          ...
          <div className="w-96">
            ...
            <h4>
              Converse com o motorista ou passageiro, alinhe detalhes e
              aproveite
            </h4>
          </div>
          ...
          <div className="w-96">
            ...
            <h4>Divida custos, ajude o meio ambiente e faça novas amizades!</h4>
          </div>
        </div>
      </div>
